...
export default function SavedSearchResults({ meal }) {
        ...
        <>
            ...
            <View style={styles.rowView}>
                <View style={styles.cellSmall}>
                    <Image source={{ uri: meal.img}} style={{ height: 50, width: 50 }}></Image>
                </View>
                <View style={styles.cellBig}>
                    <Text style={styles.text}>{meal.foodName}</Text>
                </View>
                <View style={styles.cellXSmall}>
                    <Text style={styles.text}>{meal.serveQty}</Text>
                </View>
                <View style={styles.cellBig}>
                    <Text style={styles.text}>{meal.serveUnit}</Text>
                </View>
                <View style={styles.cellSmall}>
                    <Text style={styles.text}>{meal.calories}</Text>
                </View>
            </View>
        </>
    )
